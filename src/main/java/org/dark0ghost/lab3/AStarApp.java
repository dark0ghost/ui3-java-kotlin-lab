...
import org.dark0ghost.lab3.dependencies.AStarPathfinder;
import org.dark0ghost.lab3.dependencies.Location;
import org.dark0ghost.lab3.dependencies.Map2D;
import org.dark0ghost.lab3.dependencies.Waypoint;
...
public class AStarApp {
    ...
    private void initGUI()
    {
        ...
        mapCells[startLoc.getXCoord()][startLoc.getYCoord()].setEndpoint(true);
        mapCells[finishLoc.getXCoord()][finishLoc.getYCoord()].setEndpoint(true);
    }
    ...
    private void findAndShowPath()
    {
        ...
        Map2D map = new Map2D((float)width, (float)height);
        ...
        Waypoint wp = AStarPathfinder.INSTANCE.computePath(map);

        while (wp != null)
        {
            Location loc = wp.getLocation();
            mapCells[loc.getXCoord()][loc.getYCoord()].setPath(true);
